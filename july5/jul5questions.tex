...
\noindent{\bfseries Question 4.} Your course text proves the Dimension Theorem by
...
\noindent{\bfseries Question 5.} Use the Dimension Theorem to show a linear
transformation $T: V \rightarrow V$ is invertible if and only if it is onto if
and only if it is one-to-one. \\

\noindent{\bfseries Question 6.} Let $V$ be a vector space of finite dimension,
